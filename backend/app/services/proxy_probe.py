...
def _curl_request(local_port: int, url: str, *, timeout_s: float,
                  output_path: str, compressed: bool) -> tuple[str, str]:
    command = [
...
def _apply_transport_and_tls(outbound: dict[str, object], query: dict[str, str]) -> None:
